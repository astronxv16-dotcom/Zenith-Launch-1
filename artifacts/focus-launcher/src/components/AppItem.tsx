...
export function AppItem({ app, isFolderItem = false }: AppItemProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Context menu — portal to escape transform */}
      {createPortal(
        <AnimatePresence>
          {showMenu && menuPos && (
            <>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                className="fixed inset-0 z-[100]" onClick={() => setShowMenu(false)} />
              <motion.div
                ...
                style={{
                  ...
                  top: menuPos.top,
                  left: menuPos.left,
                  width: Math.max(menuPos.width - 16, 200),
                  maxWidth: 280,
                }}
          ...
          {showFolderPicker && (
            <>
              ...
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 z-[101] p-5"
                style={{
                  ...sheetStyle,
                  maxHeight: '75dvh',
                  overflowY: 'auto',
